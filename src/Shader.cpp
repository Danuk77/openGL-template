...
/**
 * Utility function used for setting a vector with 3 values
 * @param uniform_name The uniform to set.
 * @param value The value to set the uniform to.
 */
void Shader::set_vec3(const std::string &uniform_name, glm::vec3 value) const
{
    glUniform3fv(glGetUniformLocation(id, uniform_name.c_str()), 1, glm::value_ptr(value));
}